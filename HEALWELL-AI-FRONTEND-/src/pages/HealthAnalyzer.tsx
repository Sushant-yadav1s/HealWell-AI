...
Diet: ${formData.dietPreference}
    ...
    // 🔥 DIRECT API CALL (BEST WAY)
    const response = await fetch("http://localhost:5000/weekly-planner/generate-analysis", {
      method: "POST",
      headers: {
